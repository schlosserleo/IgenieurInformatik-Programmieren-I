...
internal static class ZusaetzlicheUebung1
{
    ...
    private static List<string?> FrageNachDaten()
    {
    ...
    private static void BerechneUndGebeErgebnisAus(IReadOnlyList<string?> answers)
    {
    ...
    private static int ErmittleGanzzahl(string? number)
    {
